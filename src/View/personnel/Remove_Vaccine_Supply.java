 ...
 */
public class Remove_Vaccine_Supply extends javax.swing.JFrame {

    /**
     * Creates new form Remove_Vaccine_Supply
     */
    public Remove_Vaccine_Supply() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remove Vaccine Supply");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Vaccine Centre :");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("Vaccine Type : ");

        jCheckBox1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jCheckBox1.setText("Pfizer");

        jCheckBox2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jCheckBox2.setText("Sinovac");

        jCheckBox3.setText("AstraZeneca");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jButton1.setText("Remove Supply");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Remove_Vaccine_Supply.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Remove_Vaccine_Supply().setVisible(true);
            }
        });
    }
